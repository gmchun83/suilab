...
1. **Clone the Repository**:
   ```bash
   git clone https://github.com/GEMDevEng/PumpSui.git
   cd PumpSui
   ```
...
For a detailed directory structure, see `docs/directory_structure.md`.
...
- **GitHub**: [github.com/GEMDevEng/PumpSui](https://github.com/GEMDevEng/PumpSui)
- **Issues**: Report bugs or suggest features via [GitHub Issues](https://github.com/GEMDevEng/PumpSui/issues)

For additional documentation, see the `docs/` directory.

---

Built with 🚀 by the PumpSui team.
